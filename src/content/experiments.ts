...
export const experiments: Experiment[] = [
  {
    ...
    tried:
      'Researching local-first architectures for Vue 3, including ElectricSQL as a sync layer between a local store and a backend database. In parallel, comparing how Notion, Tana and MoreApp approach the same problem: what they keep local, when they sync, and how they handle conflicts.',
    technologies: ['Vue 3', 'TypeScript', 'ElectricSQL', 'SQL'],
    result:
      'Still research, not a shipped system. TODO: [Update once a working prototype or clearer conclusion exists] — this is a strong candidate for a future case study, not a claim that a Notion/Tana-style system has been built.',
    learned:
  ...
  },
  {
    ...
    result:
      'In progress. TODO: [Add findings once the prototype and write-up are further along].',
    learned:
